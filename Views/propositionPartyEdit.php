...
<?php if ($donnees[0]->getRoles()=== 'ROLE_ADMIN' || $donnees[0]->getRoles()=== 'ROLE_MODO' || $donnees[0]->getRoles()=== 'ROLE_USER'):;?>
    ...
    <section class="row annonce">
        ...
        <form style="width: 100%" method="post" enctype="multipart/form-data">
            ...
            <input id="title" type="text" name="title" value="<?php echo $donnees[2]->getTitle(); ?>" maxlength="150" required>
            ...
            <textarea style="width: 80%" cols="30" rows="50" id="contenu" name="content">
                <?php echo $donnees[2]->getContent(); ?>
            </textarea>
            <h3>
                <label for="images">Mettre une image en avant</label>
            </h3>
            <div>
                <img src="/projet5/Public/src/images/logos/<?php echo $donnees[2]->getImages()?>"
                     alt="images-<?php echo $donnees[2]->getTitle()?>">
            </div>
            <input id="images" type="file" name="images">
            <input id="id" type="hidden" name="id_file" value="<?php echo $donnees[0]->getId();?>">

            <input type="hidden" name="mode" value="proposition">
            <input type="hidden" name="id_party" value="<?php echo $donnees[2]->getId();?>">
